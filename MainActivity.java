                ...
                buttons[i][j].setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        if(togglebutton.isChecked()) { // ON(flag) 상태이면
                            ...
                            result=((BlockButton) view).getFlags();
                            textResult = (TextView)findViewById(R.id.textView);
                            textResult.setText("Mine : " + result.toString());
                            ...
                            if (((BlockButton) view).breakBlock()) { //지뢰가 터지면 true가 오고 끝
                                ...
                                if(!((BlockButton) view).isFlag()){
                                    chainBreak(((BlockButton) view)); //재귀로 돌려서 블록을 깨는데
                    ...
                    private void chainBreak(BlockButton bb) {
                        bb.breakBlock();
                        if (bb.getNeighborMines() != 0) { // 0이 아니면 하나만 깨
                            BlockButton.blocks--;
                            ...
                            BlockButton.blocks--;
                            // 꼭짓점 4개
                            if (bb.x== 0 && bb.y == 0) { //[0][0]
                                if(!buttons[bb.x + 1][bb.y].broken)
                                    chainBreak(buttons[bb.x + 1][bb.y]);
                                if(!buttons[bb.x][bb.y + 1].broken)
                                    chainBreak(buttons[bb.x][bb.y + 1]);
                            }
                            else if (bb.x == 0 && bb.y == 8) { //[0][8]
                                if(!buttons[bb.x + 1][bb.y].broken)
                                    chainBreak(buttons[bb.x + 1][bb.y]);
                                if(!buttons[bb.x][bb.y - 1].broken)
                                    chainBreak(buttons[bb.x][bb.y - 1]);
                            }
                            else if (bb.x == 8 && bb.y == 0) { //[8][0]
                                if(!buttons[bb.x - 1][bb.y].broken)
                                    chainBreak(buttons[bb.x - 1][bb.y]);
                                if(!buttons[bb.x][bb.y + 1].broken)
                                    chainBreak(buttons[bb.x][bb.y + 1]);
                            }
                            else if (bb.x == 8 && bb.y == 8) { //[8][8]
                                if(!buttons[bb.x - 1][bb.y].broken)
                                    chainBreak(buttons[bb.x - 1][bb.y]);
                                if(!buttons[bb.x][bb.y - 1].broken)
                                    chainBreak(buttons[bb.x][bb.y - 1]);
                            ...
                            // 모서리 네 변
                            else if (bb.x == 0 && (0 < bb.y && bb.y < 8)) { //[0][1~7]
                                if(!buttons[bb.x + 1][bb.y].broken)
                                    chainBreak(buttons[bb.x + 1][bb.y]);
                                if(!buttons[bb.x][bb.y + 1].broken)
                                    chainBreak(buttons[bb.x][bb.y + 1]);
                            ...
                            else if (bb.x == 8 && (0 < bb.y && bb.y < 8)) { //[8][1~7]
                                if(!buttons[bb.x - 1][bb.y].broken)
                                    chainBreak(buttons[bb.x - 1][bb.y]);
                                if(!buttons[bb.x][bb.y + 1].broken)
                                    chainBreak(buttons[bb.x][bb.y + 1]);
                            ...
                            else if ((0 < bb.x && bb.x <8) && bb.y == 0) { //[1~7][0]
                                if(!buttons[bb.x][bb.y + 1].broken)
                                    chainBreak(buttons[bb.x][bb.y + 1]);
                                if(!buttons[bb.x + 1][bb.y].broken)
                                    chainBreak(buttons[bb.x + 1][bb.y]);
                            ...
                            else if ((0 < bb.x && bb.x <8) && bb.y == 8) { //[1~7][8]
                                if(!buttons[bb.x][bb.y - 1].broken)
                                    chainBreak(buttons[bb.x][bb.y - 1]);
                                if(!buttons[bb.x + 1][bb.y].broken)
                                    chainBreak(buttons[bb.x + 1][bb.y]);
